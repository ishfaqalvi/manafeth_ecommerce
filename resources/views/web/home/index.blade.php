            ...
            <div class="row gap-2 gap-md-0">
                ...
                <div class="col-md-6">
                    <div class="banner-img-slider">
                        <img src="{{ asset('assets/web/images/banner-center.png') }}" alt="Banner Img" srcset="" height="auto"
                            width="100%">
                        <img src="{{ asset('assets/web/images/banner-center.png') }}" alt="Banner Img" srcset="" height="auto"
                            width="100%">
                        <img src="{{ asset('assets/web/images/banner-center.png') }}" alt="Banner Img" srcset="" height="auto"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g>
                        ...
                        <path
                            ...
                            fill="#000000" opacity="1" data-original="#000000" class="tab-nav-icon"></path>
                    </g>
                </svg><span class="ms-1">Maintenance</span></button>
        </div>
    </nav>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="product-card position-relative">
                                ...
                                <a href="http://">
                                    <img src="{{ asset('assets/web/images/p1.png') }}" alt="Product Image" srcset="" width="100%"
                                        height="auto">
                                </a>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="product-card position-relative">
                                ...
                                <a href="http://">
                                    <img src="{{ asset('assets/web/images/p2.png') }}" alt="Product Image" srcset="" width="100%"
                                        height="auto">
                                </a>
                                <div class="product-card-body">
                                    <h2 class="m-0 product-card-title">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="product-card position-relative">
                                ...
                                <a href="http://">
                                    <img src="{{ asset('assets/web/images/p3.png') }}" alt="Product Image" srcset="" width="100%"
                                        height="auto">
                                </a>
                                <div class="product-card-body">
                                    <h2 class="m-0 product-card-title">
