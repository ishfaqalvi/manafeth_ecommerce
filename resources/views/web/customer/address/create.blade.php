...
@section('customer_account')
    <form method="POST" action="{{ route('address.store') }}" class="w-100 my-acount-detail-form d-flex flex-column border-all-form-outline bg-white" role="form" enctype="multipart/form-data" id="validate">
        @csrf
