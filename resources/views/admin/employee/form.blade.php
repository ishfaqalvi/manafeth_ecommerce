<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" value="{{ old('mobile_number', $employee?->mobile_number) }}" id="mobile_number" placeholder="Mobile Number">
            {!! $errors->first('mobile_number', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="image" class="form-control @error('image') is-invalid @enderror" value="{{ old('image', $employee?->image) }}" id="image" placeholder="Image">
