...
<div class="page-header-content d-lg-flex">
    <div class="d-flex">
        <h4 class="page-title mb-0">
            Home - <span class="fw-normal">Rent Products Managment</span>
        </h4>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('products.rent.filter')}}" method="post">
                @csrf
                @include('admin.product.rent.filter')
            </form>
        </div>
    </div>
    <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @include('admin.product.rent.actions')
                        </td>
                    </tr>
                    @empty
                    <tr>
...
@include('admin.product.rent.addToCart')
@endsection
