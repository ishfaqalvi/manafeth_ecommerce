...
<div class="page-header-content d-lg-flex">
    ...
    <div class="d-lg-block my-lg-auto ms-lg-auto">
        <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
            <a href="{{ route('products.sale.index') }}" class="btn btn-outline-primary btn-labeled btn-labeled-start rounded-pill">
...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('products.sale.store') }}" class="validate" role="form" enctype="multipart/form-data">
                @csrf
