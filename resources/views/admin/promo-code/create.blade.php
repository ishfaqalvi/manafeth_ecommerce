...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{ __('Create') }} Promo Code</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('promo-codes.store') }}" class="validate" role="form" enctype="multipart/form-data">
                @csrf
...
<script>
    $(function(){
        ...
        ['.valid_from', '.valid_until'].forEach(selector => {
