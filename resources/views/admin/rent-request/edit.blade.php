...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('rent.updateDetail') }}" class="validate"   role="form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 mb-3">
                        {{ Form::label('quantity') }}
                        {{ Form::number('quantity', $detail->quantity, ['class' => 'form-control' . ($errors->has('quantity') ? ' is-invalid' : ''), 'placeholder' => 'Quantity', 'min' => '1','required']) }}
                    </div>
                    <div class="form-group col-lg-4 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        @php($sTotal = ($detail->productRent->amount ?? 0)*($detail->quantity))
                        <div class="form-group mb-3">
                            <strong>Sub Total---------------------:</strong>
                            {{ $detail->productRent->amount.' X '. $detail->quantity. ' = ' . $sTotal }}
                        </div>
                        <div class="form-group mb-3">
                            <strong>Delivery Charges------------:</strong>
                            {{ $detail->delivery_charges ?? 0 }}
                        </div>
                        <div class="form-group mb-3">
