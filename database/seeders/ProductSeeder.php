...
class ProductSeeder extends Seeder
{
    ...
    {
        $types = ['Rent', 'Sale', 'Maintenance'];
        $productsPerType = 15; // Number of products per type

        foreach ($types as $type) {
            for ($i = 1; $i <= $productsPerType; $i++) {
                DB::table('products')->insert([
                    'brand_id' => 1, // Example brand_id
                    'category_id' => 1, // Example category_id
                    'sub_category_id' => 1, // Example sub_category_id
                    'name' => "Product Name {$type} {$i}",
                    'serial_number' => "SN-{$type}-{$i}",
                    ...
                    'quantity' => 10,
                    'price' => 1000 * $i,
                    'discount' => ($i % 2) * 10, // Example condition for discount
                    'type' => $type,
                    'special' => ($i % 2 == 0) ? 'Yes' : null,
                    'status' => 'Publish',
                    'created_at' => now(),
                    'updated_at' => now(),
                ]);
